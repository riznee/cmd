...
use App\Repositries\PageLayoutRepository;
...
class PageLayoutController extends Controller
{
    ...
    public function __construct(PageLayoutRepository $repository)
    {
    ...
    public function index()
    {
        ...
        $pagelayoutlist = $this->repository->getall();
        $action = true;
        $data = array('data'=> "not null");
        return view('pagelayouts.index', compact('headers','pagelayoutlist','permisson','action','data'));
    }
